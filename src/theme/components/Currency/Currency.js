        ...
        <CurrencyWrapper {...forwardProps}>
                ...
                <SVG width="27" height="28">
                    ...
                    <defs>
                        ...
                        <clipPath id="currencyclip1">
                            <path
                                fill="#fff"
                                transform="translate(4.219 4.416)"
            ...
            {currency === 'ETH/ERC20' && (
                <SVG width="27" height="28">
                    ...
                    />
                    <path
                        d="M13.92 3.572v7.484l6.325 2.827L13.92 3.572z"
                        fill="#fff"
                        fillOpacity=".602"
                    />
                    <path
                        d="M13.92 3.572l-6.326 10.31 6.326-2.826V3.572z"
                        fill="#fff"
                    />
                    <path
                        d="M13.92 18.732v5.086l6.33-8.758-6.33 3.672z"
                        fill="#fff"
                        fillOpacity=".602"
                    />
                    <path
                        d="M13.92 23.818V18.73l-6.326-3.67 6.326 8.757z"
                        fill="#fff"
                    />
                    <path
                        d="M13.92 17.556l6.325-3.673-6.325-2.825v6.498z"
                        fill="#fff"
                        fillOpacity=".2"
                    />
                    <path
                        d="M7.594 13.883l6.326 3.673v-6.498l-6.326 2.825z"
                        fill="#fff"
                        fillOpacity=".602"
                    />
                </SVG>
...
Currency.propTypes = {
    currency: PropTypes.oneOf(['BTC', 'CELO', 'ETH/ERC20']),
}
